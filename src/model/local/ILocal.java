...
import model.local.action_see.IActionSee;
import model.local.action_jump.IActionJump;
import model.local.action_GoTo.IActionGoTo;
import model.local.action_down.IActionDown;
import model.local.action_climbing.IActionClimbing;
    ...
    public void update(IObservable ob) {
        switch (ob.getType()) {
            ...
            case IObject.TYPE:
                ...
                if(obj.getState().equals("inventory")){
                    objects.remove(obj);
                }else if(obj.getState().equals("local")){
                    objects.add(obj);
                }
                break;
            case Character.TYPE:
