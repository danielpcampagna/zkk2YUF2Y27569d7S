 ...
 * @author Daniel
 */
public final class SimpleMessage implements IView {
    ...
    public SimpleMessage(String message) throws IllegalArgumentException {
        this("", message);
        this.hasTitle = false;
    }
    ...
    public SimpleMessage(String symbol, String title, String message, int width) throws IllegalArgumentException {
        this(symbol, title, message, width, HASH, HASH);
    }

    public SimpleMessage(String symbol, String title, String message, int width, String vertical, String horizontal) throws IllegalArgumentException {
        this.setTitle(title);
    ...
    private void formatMessage() {
        ...
        for (int i = 0; i < message.length(); i++) {
            ...
            if (message.toCharArray()[i] == '\n') {
                ...
                resp = resp + message.toCharArray()[i];
            }
        }
        while (resp.length() % (width - 1) != 0) {
            resp += " ";
